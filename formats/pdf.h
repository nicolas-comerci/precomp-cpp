...
public:
  ...
  pdf_precompression_result(int img_width, int img_height): deflate_precompression_result(D_PDF), img_width(img_width), img_height(img_height) {}
...
pdf_precompression_result try_decompression_pdf(Precomp& precomp_mgr, int pdf_header_length, int img_width, int img_height, int img_bpc) {
